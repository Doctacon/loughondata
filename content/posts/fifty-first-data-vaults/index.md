---
title: "Data Vault walk-through: Fifty First Data Vaults"
date: 2023-12-15
draft: false
summary: "A talk to the UK Data Vault User Group on what went wrong (and right) across many iterations of building data vaults, and why the methodology is worth the heartache."
tags: ["data-vault", "dbt", "data-modeling"]
---

E pluribus unum — from many, one. With a slight edit, "from many, ~~one~~ a few," we have a good starting point for understanding why anyone might want to go from "sprawling dbt project" to the data vault modeling methodology. Because amongst that sprawl (the many) are really only around a dozen-ish overarching business concepts (the few).
